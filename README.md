...
ასევე საინტერესოა LR-ის precision/recall პროფილი: მაღალი recall (0.75), დაბალი precision (0.10) — მოდელი აგრესიულია fraud-ის დაპრედიქტებისას, ბევრი false alarm-ით.
