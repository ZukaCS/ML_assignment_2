...
- **underfit**-იც არაა გამოკვეთილი ამ მოდელებში. ყველაზე ცუდ მოდელს თუ შევხედავთ ის 0.02 ით ჩამორჩება საუკეთესო მოდელის test_auc შედეგს. შეიძლება ითქვას, რომ მცირე underfit გვაქვს ამ შემთხვევაში, მაგრამ არაფერი გრანდიოზული.
...
- მიუხედავად ამისა, მივიღე ბევრი გამორჩეული **underfitted** მოდელი. ქვედა ოთხი მოდელი, მაგალითად, ცხადია, რომ ძალიან underfitted- არის. n = 5 ის მოდელს არ ეყო 5 ცალი weak learner-ი მთლიანი დამოკიდებულებების სასწავლად. ხოლო შედარებით მაღალი n ებისთვის, ქვედა მოდელებისთვის, learning rate ძალიან მაღალი აღმოჩნდა. ანუ ადაბუსტის ალგორითმი ქვედა სამ შემთხვევაში ძალიან აგრესიულად overcorrect-ს უკეთებს წინა boosting ensemble-ს შედეგს, საბოლოოდ კი საერთოდ ვერ სწავლობს დამოკიდებულებებს.
...
#### XGBoost-ის cleaning threshold-ის არჩევა

XGBoost-ს native NaN handling აქვს, ამიტომ მაინტერესებდა, სჭირდება თუ არა column-ების დადროპვა. გავტესტე cleaning-ის 4 სხვადასხვა threshold-ი XGBoost baseline მოდელზე.

| Cleaning Threshold | დარჩენილი სვეტების რაოდენობა | Test AUC |
|-----------|--------------------|----------|
| 0.50  | 265 | 0.9422 |
| **0.75 ( არჩეული)** | **277** | **0.9428** |
| 0.95 | 676 | 0.9424 |
| 1.01 | 694 | 0.9413 |

შედეგები ერთმანეთის მსგავსი გამოვიდა. ეს ადასტურებს, რომ XGBoost-ის native NaN handling მართლაც კარგად მუშაობს, მაშინაც კი, როცა 694 ცვლადს ვტოვებ (no drop), AUC მხოლოდ 0.0015-ით ეცემა საუკეთესო შედეგზე.

ავირჩიე 0.75 threshold-ი preprocessing-ისთვის კლასიკურად, როგორც წინა მოდელებში მქონდა.
