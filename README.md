...
- ზედა მოდელები არ ავირჩიე, რადგან დაზეპირებული აქვთ training data - test_auc 1.0 აქვთ, რაც **overfit** ის ნიშანია. შეიძლება kaggle-ს საბოლოო ტესტზე ამის გამო კარგი შედეგი არ დადონ. ცხადიცაა ზედა მოდელები რატომ აკეთებენ ოვერფიტს: სიღრმის შეზღუდვა საერთოდ არ აქვთ და რეგულარიზაციის პარამეტრიც დაბალი აქვთ l = 1.
